...
In order to differentiate functionalities for the various types of users, the application will be accessible by three different clients, one for each kind of user (Policeman, Municipal Authority and Regular User). Moreover, SS services can be accessed by authorities/institution from a webpage which garantees acknowledge institution registration and SS advanced feature access.\newline
