...
\begin{itemize} 
	...
	\end{itemize}
		Considering the server endpoint of SS service the development of an high performance DataBase is reguarded as a main concern for the application scope.
