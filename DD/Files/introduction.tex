...
\begin{itemize}
	\item Users: The simple users that want to report a traffic violation or want to see the most unsafe areas of a city.
	\item Policemen: Members of the police that need to access the data about users' reports. 
...
A registration is needed to exploit the various functionalities, reducing the possibility of false reports and granting more privacy.
To ensure an even higher level of privacy, SafeStreets will ask users the permission to access data from the device, such as the geographical position.
